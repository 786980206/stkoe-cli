...
class ICCumsController:
    ...
    def __init__(self, model: FactorTestModel, view: ICCumsView) -> None:
        self._model = model
        self._view = view
        self._bind_events()
...
class ICCumsViewer:
    ...
    def __init__(self, model: FactorTestModel) -> None:
        if model.ic_test is None:
            ...
            self._view = ICCumsView(model.get_spec_json("ic_test"))
            self._controller = ICCumsController(model, self._view)
